...
import { CircleCheck, X, Loader2 } from 'lucide-react';
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-gray-600 mt-1">
              {generatedImages.length > 0 
                ? "Here are your personalized jewelry recommendations" 
                ...
                <div key={index} className="relative overflow-hidden rounded-lg bg-white shadow-sm">
                  <div className="relative group">
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                      <button 
                        onClick={() => handleDownloadImage(url, `jewelry-design-${index + 1}.png`)}
                  ...
                  <div className="p-2 bg-white">
                    <p className="text-sm font-medium text-gray-800">Generated Design {index + 1}</p>
                  </div>
                </div>
              ))}
            </div>
